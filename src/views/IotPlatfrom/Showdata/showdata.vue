<template>
    ...
    <div class="flexmain" style="width: 100%;height:100%;display: flex">
        ...
        <div id="first" style="position:absolute;width: 65%;height:80%;">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            first: function () {
                const colors = ['#47bbad', 'rgba(187,154,52,0.6)', '#fd7347', 'rgba(46,83,196,0.78)'];
                var firstoption;
                //     username:name
                // }
                ...
                firstoption = {
                    ...
                    tooltip: {
                        ...
                        formatter: '{a0}: {c0}<br />{a1}: {c1}JTU<br />{a2}: {c2}°C<br />{a3}: {c3}mg/L',
